  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 pb-0 px-4 md:px-8 lg:px-10">
        <h2 className="text-2xl gap-2 sm:gap-4 items-center flex font-bold md:text-4xl mb-4 text-blue-950 dark:text-white max-w-4xl">
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-16">
        {data.map((item, index) => (
          <div
            key={index}
            className="flex justify-start pt-10 md:pt-32 md:gap-4"
          >
